...
class Shards(Mode):
    ...
    def render(self, buf, w, h, t, frame, cfg, pal, syms):
        ...
        bodies = [(w * 0.78, h * 0.24, w * 0.18, h * 0.10), (w * 0.72, h * 0.46, w * 0.20, h * 0.12), (w * 0.80, h * 0.74, w * 0.19, h * 0.11)]
        for y in range(h):
            for x in range(w):
                base = None
                ...
                ripple = math.sin((sx * 0.10) - tf * 1.8) * 0.22 + math.cos((y * 0.24) + tf * 1.3) * 0.18 + math.sin((sx + y) * 0.08 + tf * 2.0) * 0.16
