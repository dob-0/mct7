...
DEFAULTS = {
    ...
    'map_cursor_x': None,
    'map_cursor_y': None,
    'event_title': 'MUSEUM OF THE ABOVYAN',
    'event_kicker': 'MUSEUM ->',
    'event_when': 'MAY 16',
    'event_where': 'MUSEUM',
    'event_stage_a': 'ARCHIVE',
    'event_stage_b': 'COURTYARD',
    'event_lineup': 'MANUSCRIPT LIGHT|INK FIELD|STONE MEMORY|WINDOW TRACE|COURTYARD SIGNAL|BOOK SHADOW|ROOM TONE|MUSEUM ECHO|YEREVAN AIR|NIGHT READING',
    'event_lineup_a': 'MANUSCRIPT LIGHT|INK FIELD|STONE MEMORY|WINDOW TRACE|COURTYARD SIGNAL',
    'event_lineup_b': 'BOOK SHADOW|ROOM TONE|MUSEUM ECHO|YEREVAN AIR|NIGHT READING',
    'event_footer': 'LIVE VISUALS IN THE MUSEUM',
}
