...
DEFAULTS = {
    ...
    'map_cursor_x': None,
    'map_cursor_y': None,
    'event_title': 'BR_ID_GE',
    'event_kicker': 'GYUMRI <-> MUNICH',
    'event_when': '121-228MS',
    'event_where': 'LATENT SPACE',
    'event_stage_a': 'GYUMRI [TUFF]',
    'event_stage_b': 'MUNICH [STEEL]',
    'event_lineup': 'AI STITCH|SHARED BODY|GHOST HAND|LATENT HANDSHAKE|ARMENIAN EMOTION|GERMAN LIGHT|DIGITAL ARCHITECTURE|NETWORK LAG|RECIPROCAL TRAP|POINT CLOUDS',
    'event_lineup_a': 'AI STITCH|SHARED BODY|GHOST HAND|LATENT HANDSHAKE|ARMENIAN EMOTION',
    'event_lineup_b': 'GERMAN LIGHT|DIGITAL ARCHITECTURE|NETWORK LAG|RECIPROCAL TRAP|POINT CLOUDS',
    'event_footer': 'TELE-SYMBIOTIC XR PERFORMANCE',
}
